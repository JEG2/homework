...
needs = Tables.new
needs.add_choice("Need: To get the truth about", [
...
needs.add_choice("Need: To get respect from...", [
...
needs.add_choice("Need: To hide that...", [
...
needs.add_choice("Need: To finally take care of", [
...
needs.add_choice("Need: To get away...", [
...
locations.add_choice("Location: The Mission - Flashback", [
...
locations.add_choice("Location: Groton Naval Base - Flashback", [
...
locations.add_choice("Location: The Island - Flashback", [
...
locations.add_choice("Location: Where we do things", [
...
locations.add_choice("Location: Where we keep things", [
...
locations.add_choice("Location: Where we currently avoid", [
...
objects = Tables.new
objects.add_choice("Object: Weapon", [
  "Colt M1911 pistol", 
  "M3A1 'grease gun'", 
...
objects.add_choice("Object: Tools", [
...
objects.add_choice("Object: Missing and unaccointed for", [
...
objects.add_choice("Object: Strange Comfort", [
...
objects.add_choice("Object: Memories", [
...
objects.add_choice("Object: Disturbing", [
...
class Runner
  ...
  def run
    ...
    details.each_with_index do |subcategory, i|
      ...
      puts "  #{@relationships.statement(@dice[d], @dice[d + 1])}"
      puts subcategory.statement(@dice[d + 2], @dice[d + 3])
      puts
    end
  end
end
