...
while cycles < total
  ...
  if cycles > a and tables == minor_tables
    tables = med_tables
  end
  ...
  if choice == "Armor and shields"
    if item == "Specific armor" or item == "Specific shield"
      armor = choose_from_table(tables[item])
    end

    if item == "Special ability and roll again"
      armor = choose_from_table(tables["Armor and shields"])
      if armor == "+1 armor" or armor == "+2 armor" or armor == "+3 armor" or armor == "+4 armor" or armor == "+5 armor" or armor == "Specific armor"
        spec = "Special armor"
      else
        spec = "Special shield"
      end
      special = choose_from_table(tables[spec])
    end
  ...
  if choice == "Weapons"
    ...
    if weapon == "Slaying arrow"
      slay = choose_from_table(minor_tables["Slaying arrow"])
    end
